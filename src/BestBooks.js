    ...
    return (
      <Jumbotron>
        ...
        <div className="bookcont">
          ...
          <>
            <Modal show={this.state.showBooks} onHide={this.handleClose}>
              ...
              <Modal.Body>
                <Form >
                  <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control  onSubmit={this.addBook} type="text" placeholder="book name" name='bookName' />
